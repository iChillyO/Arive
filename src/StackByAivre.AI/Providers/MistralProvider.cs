...
public class MistralProvider : IAiService
{
    ...
    public MistralProvider(HttpClient httpClient, IConfiguration configuration)
    {
        _httpClient = httpClient;
        _apiKey = configuration["AiProviders:MistralApiKey"] ?? string.Empty;
