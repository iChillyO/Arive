...
export default function LoginPage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    e.preventDefault();
    setLoading(true);
    // signIn("credentials", { email, password, redirect: true, callbackUrl: "/workspace" })
  ...
  return (
    <div className="min-h-screen bg-black flex items-center justify-center p-6 relative overflow-hidden">
      ...
      <motion.div
        className="absolute top-1/3 left-1/3 w-[500px] h-[500px] rounded-full opacity-10 blur-3xl"
